...
8. 명확하게 채점 기준에 따른 내용이 모두 포함된 경우에만 **만점(1~2점)**을 부여하세요.
9. 단어만 언급하거나 의미가 불명확한 경우는 **0점 또는 부분점수(0.5점 이하)**를 부여하세요.
10. 불완전하거나 비논리적인 설명은 반드시 감점 대상입니다.
11. 각 항목에 대해 "구체적인 내용 확인"이 없으면 점수를 주지 마세요.
12. 전체 점수는 문제별 배점을 절대 초과하면 안 됩니다.
   **총점: XX점**
