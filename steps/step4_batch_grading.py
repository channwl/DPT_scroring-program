...
10. 항목별 기준에 한 항목이라도 충족하지 못한 경우, 부분 감점을 반드시 적용하세요. 관대하게 채점하지 마세요.
11. 정답과 완벽하게 일치하지 않는 설명은 부분 감점 처리하세요. 유사 개념은 점수 부여 대상이 아닙니다.
12.핵심 용어, 정의, 예시가 빠진 경우는 모두 감점 대상입니다."
13. 표 아래에 다음 문장을 작성하세요:
   **총점: XX점**
