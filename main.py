...
채점 결과를 아래 형식으로 작성하세요:
 - 마크다운 표로 항목별 점수와 평가 근거
 - 이후 ** 근거 문장 ** 이라는 제목 아래 항목별로 실제 학생 답안에서 발췌한 문장을 항목별로 최대 3개씩 작성하세요
 - 문장은 반드시 쌍따옴표로 묶어주세요.
...
**평가 근거는 반드시 학생 답안의 원문 문장을 그대로 따옴표로 묶어 사용해야 하며, 항목당 2~3개 정도를 명시적으로 추출**해 주세요.
